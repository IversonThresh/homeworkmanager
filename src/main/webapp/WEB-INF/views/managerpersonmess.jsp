...
<div class="beg-login-box box box-register layui-anim-rotate" id="login">
    ...
    <div class="beg-login-main">
        <form action="/zuoyeguanliuser/updateMess.do" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <input id="email" type="text" name="email" lay-verify="password" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <input id="determine_password_register" type="text" name="password" lay-verify="password"
