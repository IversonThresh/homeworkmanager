...
<div class="beg-login-box box box-register layui-anim-rotate" id="login">
    ...
    <div class="beg-login-main">
        <form action="/zuoyeguanli/student/updateStudent.do?flag=Y" class="layui-form" method="post">
            <input type="hidden" value="${student.studentid}" name="sid">
            ...
            <div class="layui-form-item">
                ...
                <input id="password_register" type="text" name="password" lay-verify="password" autocomplete="off"
                       value="${student.password}" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe6b2;</i>
                ...
                <input id="regcode_register" type="text" name="smajor" lay-verify="regcode" autocomplete="off"
                       value="${student.smajor}" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe6b2;</i>
                ...
                <input id="sgrade" type="text" name="sgrade" lay-verify="regcode" autocomplete="off"
                       value="${student.sgrade}" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe6b2;</i>
                </label>
                <input id="class" type="text" name="sclass" lay-verify="regcode" autocomplete="off"
                       value="${student.sclass}" class="layui-input">
            </div>
            <div class="layui-form-item" >
