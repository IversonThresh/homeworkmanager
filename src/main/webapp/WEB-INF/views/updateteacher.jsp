...
<div class="beg-login-box box box-register layui-anim-rotate" id="login">
    <header>
        <h1 style="color:#FFFFFF">教师相关信息</h1>
    </header>
    <div class="beg-login-main">
        <form action="/zuoyeguanli/teacher/updateTeacher.do?flag=Y" class="layui-form" method="post">

            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe612;</i>
                </label>
                <input id="username_register" type="text" name="teachername" lay-verify="userName" autocomplete="off"
                       value="${teacher.teachername}" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe642;</i>
                </label>
                <input id="password_register" type="text" name="password" lay-verify="password" autocomplete="off"
                       value="${teacher.password}" class="layui-input">
            </div>
            <%--<div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe642;</i>
            ...
            <div class="layui-form-item">
                ...
                <input id="regcode_register" type="text" name="phone" lay-verify="regcode" autocomplete="off"
            ...
            <input type="hidden" value="${teacher.tno}" name="tno">
