...
<div class="beg-login-box box box-register layui-anim-rotate" id="login">
    <header>
        <h1 style="color:#FFFFFF">请输入教师相关信息</h1>
    </header>
    <div class="beg-login-main">
        <form action="/zuoyeguanli/manager/managerMess.do?flag=Y" class="layui-form" method="post">

            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe612;</i>
                </label>
                <input id="coursename" type="text" name="coursename" lay-verify="userName" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <input id="cmajor" type="text" name="cmajor" lay-verify="password" autocomplete="off"
            ...
            <div class="layui-form-item">
                ...
                <input id="cgrade" type="text" name="cgrade" lay-verify="password"
            ...
            <div class="layui-form-item">
                ...
                <input id="tno" type="text" name="tno" lay-verify="regcode" autocomplete="off"
